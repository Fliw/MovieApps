...
public class MovieAdapter extends RecyclerView.Adapter<MovieAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        TextView movieTitle, movieRelease, movieDescription, movieRating;
...
//          movieDescription= itemView.findViewById(R.id.tvMovieDesc);
        ...
        public void bind(Movie movie){
            ...
            movieRelease.setText( movie.getRating());
//            itemView.getContext().getString(R.string.text_release,
//            movieDescription.setText(movie.getDescription());
            //itemView.getContext().getString(R.string.text_description) + "\n" +
